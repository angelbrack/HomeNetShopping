package korea.wrk.brd.common.service.impl;
...
import korea.wrk.brd.common.service.MgntBCommonService;
import korea.wrk.brd.common.service.BoardVO;
...
public class MgntBCommonServiceImpl implements MgntBCommonService {
	...
	public List<EgovMap> retrieveList(BoardVO vo) throws Exception {
		return mybatisDataAccessDAO.list("korea.wrk.brd.common.service.MgntBCommonService.selectMBOBoardoutService_S01", vo);
	}
	...
	public int retrieveCount(BoardVO vo) throws Exception {
		return (Integer) mybatisDataAccessDAO.select("korea.wrk.brd.common.service.MgntBCommonService.selectMBOBoardoutService_S02", vo);
	}
	...
	public List<EgovMap> retrieveListSrchwrd(BoardVO vo) throws Exception {
		return mybatisDataAccessDAO.list("korea.wrk.brd.common.service.MgntBCommonService.selectMBOBoardoutService_S08", vo);
	}
	...
	public BoardVO retrieveBoardOtpInfo(BoardVO vo) throws Exception {
		return (BoardVO) mybatisDataAccessDAO.select("korea.wrk.brd.common.service.MgntBCommonService.selectMBOBoardoutService_S03", vo);
	}
	...
	public BoardVO retrieveInfo(BoardVO vo) throws Exception {
		return (BoardVO) mybatisDataAccessDAO.select("korea.wrk.brd.common.service.MgntBCommonService.selectMBOBoardoutService_S05", vo);
	}
	...
	public List<EgovMap> retrieveFile(BoardVO vo) throws Exception {
		return mybatisDataAccessDAO.list("korea.wrk.brd.common.service.MgntBCommonService.selectMBOBoardoutService_S06", vo);
	}
	...
	public List<EgovMap> retrieveFileThumb(BoardVO vo) throws Exception {
		return mybatisDataAccessDAO.list("korea.wrk.brd.common.service.MgntBCommonService.selectMBOBoardoutService_S07", vo);
	}
	...
	public List<EgovMap> retrieveFileAns(BoardVO vo) throws Exception {
		return mybatisDataAccessDAO.list("korea.wrk.brd.common.service.MgntBCommonService.selectMBOBoardoutService_S09", vo);
	}
	...
	public String bdotSeq() throws Exception {
		return (String) mybatisDataAccessDAO.select("korea.wrk.brd.common.service.MgntBCommonService.selectMBOBoardoutService_S04", null);
	}
	...
	public int register(BoardVO vo) throws Exception {
		...
		result += (Integer) mybatisDataAccessDAO.insert("korea.wrk.brd.common.service.MgntBCommonService.insertMBOBoardoutService_I01", vo);
		result += (Integer) mybatisDataAccessDAO.insert("korea.wrk.brd.common.service.MgntBCommonService.insertMBOBoardoutService_I02", vo);
	...
	public int modify(BoardVO vo, HttpServletRequest request) throws Exception {
		...
		result += (Integer) mybatisDataAccessDAO.update("korea.wrk.brd.common.service.MgntBCommonService.updateMBOBoardoutService_U01", vo);

		if (vo.getAnsUseYn() != null && vo.getAnsUseYn().equals("Y")) {
			result += (Integer) mybatisDataAccessDAO.delete("korea.wrk.brd.common.service.MgntBCommonService.deleteMBOBoardoutService_D01", vo);
			result += (Integer) mybatisDataAccessDAO.insert("korea.wrk.brd.common.service.MgntBCommonService.insertMBOBoardoutService_I02", vo);
			...
			result += (Integer) mybatisDataAccessDAO.insert("korea.wrk.brd.common.service.MgntBCommonService.updateMBOBoardoutService_U02", vo);
		}
	...
	public int modifyAns(BoardVO vo) throws Exception {
		...
		result += (Integer) mybatisDataAccessDAO.update("korea.wrk.brd.common.service.MgntBCommonService.updateMBOBoardoutService_U04", vo);
	...
	public int delete(BoardVO vo) throws Exception {
		...
		result += (Integer) mybatisDataAccessDAO.update("korea.wrk.brd.common.service.MgntBCommonService.updateMBOBoardoutService_U03", vo);
