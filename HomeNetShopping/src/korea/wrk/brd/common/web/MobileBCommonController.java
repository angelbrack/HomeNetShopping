package korea.wrk.brd.common.web;
 ...
 */
@Controller
public class MobileBCommonController {
	 ...
	 * 개정이력 : 없음
	 */	
	@RequestMapping(value = { "/mobile/brd/notice/notice.do"				// 공지사항
			, "/mobile/brd/faq/faq.do" 									// 자주묻는질문
			, "/mobile/brd/qna/qna.do"									// 문의내역 
			, "/mobile/brd/data/data.do"									// 취업노하우
	})
	public String initUBDBoardout(@ModelAttribute("searchVO") UserBoardVO vo, HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		if (urlPath.indexOf("/mobile/brd/notice/notice.do") > -1) {			// 공지사항
			vo.setBoardType("notice");
			vo.setBoardType2("Notice");
			vo.setBlbdDvCd("001");
			vo.setSearchNotcYn("Y");
			vo.setListUrl("/mobile/brd/notice/notice.do");
			vo.setViewUrl("/mobile/brd/notice/noticeView.do");
		} else if (urlPath.indexOf("/mobile/brd/faq/faq.do") > -1) {			// C
			vo.setBoardType("faq");
			vo.setBoardType2("Faq");
			vo.setBlbdDvCd("002");
			vo.setSearchNotcYn("Y");
			vo.setListUrl("/mobile/brd/faq/faq.do");
			vo.setViewUrl("/mobile/brd/faq/faqView.do");
		} else if (urlPath.indexOf("/mobile/brd/qna/qna.do") > -1) {	// 문의내역
			vo.setBoardType("qna");
			vo.setBoardType2("Qna");
			vo.setBlbdDvCd("003");
			vo.setListUrl("/mobile/brd/qna/qna.do");
			vo.setViewUrl("/mobile/brd/qna/qnaView.do");
		} else if (urlPath.indexOf("/mobile/brd/data/data.do") > -1) {		// 취업노하우
			vo.setBoardType("data");
			vo.setBoardType2("Data");
			vo.setBlbdDvCd("004");
			vo.setSearchNotcYn("Y");
			vo.setListUrl("/mobile/brd/data/data.do");
			vo.setViewUrl("/mobile/brd/data/dataView.do");
		}
		...
		/*if (urlPath.indexOf("/mobile/brd/faq/faq.do") > -1) {
			return "/mobile/brd/" + vo.getBoardType() + "/brd" + vo.getBoardType2() + "View";
		} else {
			return "/mobile/brd/" + vo.getBoardType() + "/brd" + vo.getBoardType2() + "List";
		}*/
		return "/mobile/brd/" + vo.getBoardType() + "/brdA" + vo.getBoardType2() + "List";
	}
	 ...
	 * 개정이력 : 없음
	 */	
	@RequestMapping(value = { "/mobile/brd/notice/engNotice.do"			// 공지사항
			, "/mobile/brd/faq/engFaq.do" 									// 자주묻는질문
			, "/mobile/brd/qna/engQna.do"									// 문의내역 
			, "/mobile/brd/data/engData.do"									// 취업노하우
	})
	public String initUBDEngBoardout(@ModelAttribute("searchVO") UserBoardVO vo, HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		if (urlPath.indexOf("/mobile/brd/notice/engNotice.do") > -1) {			// 공지사항
			vo.setBoardType("notice");
			vo.setBoardType2("Notice");
			vo.setBlbdDvCd("001");
			vo.setSearchNotcYn("Y");
			vo.setListUrl("/mobile/brd/notice/engNotice.do");
			vo.setViewUrl("/mobile/brd/notice/engNoticeView.do");
		} else if (urlPath.indexOf("/mobile/brd/faq/engFaq.do") > -1) {			// C
			vo.setBoardType("faq");
			vo.setBoardType2("Faq");
			vo.setBlbdDvCd("002");
			vo.setSearchNotcYn("Y");
			vo.setListUrl("/mobile/brd/faq/engFaq.do");
			vo.setViewUrl("/mobile/brd/faq/engFaqView.do");
		} else if (urlPath.indexOf("/mobile/brd/qna/engQna.do") > -1) {	// 문의내역
			vo.setBoardType("qna");
			vo.setBoardType2("Qna");
			vo.setBlbdDvCd("003");
			vo.setListUrl("/mobile/brd/qna/engQna.do");
			vo.setViewUrl("/mobile/brd/qna/engQnaView.do");
		} else if (urlPath.indexOf("/mobile/brd/data/engData.do") > -1) {		// 취업노하우
			vo.setBoardType("data");
			vo.setBoardType2("Data");
			vo.setBlbdDvCd("004");
			vo.setSearchNotcYn("Y");
			vo.setListUrl("/mobile/brd/data/engData.do");
			vo.setViewUrl("/mobile/brd/data/engDataView.do");
		}
		...
		return "/mobile/brd/" + vo.getBoardType() + "/brdAEng" + vo.getBoardType2() + "List";
	}
	 ...
	 * 개정이력 : 없음
	 */
	@RequestMapping(value = { "/mobile/brd/notice/noticeView.do"			// 공지사항
			, "/mobile/brd/faq/faqView.do" 								// 자주묻는질문
			, "/mobile/brd/qna/qnaView.do"								// 문의내역
			, "/mobile/brd/data/dataView.do"								// 취업노하우
	})
	public String retrieveUBDBoardout(ModelMap model, @ModelAttribute("searchVO") UserBoardVO vo, HttpServletRequest request) throws Exception {
		...
		if (urlPath.indexOf("/mobile/brd/notice/noticeView.do") > -1) {			// 공지사항
			vo.setBoardType("notice");
			vo.setBoardType2("Notice");
			vo.setBlbdDvCd("001");
			vo.setListUrl("/mobile/brd/notice/notice.do");
			vo.setViewUrl("/mobile/brd/notice/noticeView.do");
		} else if (urlPath.indexOf("/mobile/brd/faq/faqView.do") > -1) {			// 자주묻는질문
			vo.setBoardType("faq");
			vo.setBoardType2("Faq");
			vo.setBlbdDvCd("002");
			vo.setListUrl("/mobile/brd/faq/faq.do");
			vo.setViewUrl("/mobile/brd/faq/faqView.do");
		} else if (urlPath.indexOf("/mobile/brd/qna/qnaView.do") > -1) {	// 문의내역
			vo.setBoardType("qna");
			vo.setBoardType2("Qna");
			vo.setBlbdDvCd("003");
			vo.setListUrl("/mobile/brd/qna/qna.do");
			vo.setViewUrl("/mobile/brd/qna/qnaView.do");
		} else if (urlPath.indexOf("/mobile/brd/data/dataView.do") > -1) {		// 취업노하우
			vo.setBoardType("data");
			vo.setBoardType2("Data");
			vo.setBlbdDvCd("004");
			vo.setListUrl("/mobile/brd/data/data.do");
		...
		return "/mobile/brd/" + vo.getBoardType() + "/brdA" + vo.getBoardType2() + "View";
	}
	 ...
	 * 개정이력 : 없음
	 */
	@RequestMapping(value = { "/mobile/brd/notice/engNoticeView.do"			// 공지사항
			, "/mobile/brd/faq/engFaqView.do" 								// 자주묻는질문
			, "/mobile/brd/qna/engQnaView.do"								// 문의내역
			, "/mobile/brd/data/engDataView.do"								// 취업노하우
	})
	public String retrieveUBDEngBoardout(ModelMap model, @ModelAttribute("searchVO") UserBoardVO vo, HttpServletRequest request) throws Exception {
		...
		if (urlPath.indexOf("/mobile/brd/notice/engNoticeView.do") > -1) {			// 공지사항
			vo.setBoardType("notice");
			vo.setBoardType2("Notice");
			vo.setBlbdDvCd("001");
			vo.setListUrl("/mobile/brd/notice/engNotice.do");
			vo.setViewUrl("/mobile/brd/notice/engNoticeView.do");
		} else if (urlPath.indexOf("/mobile/brd/faq/engFaqView.do") > -1) {			// 자주묻는질문
			vo.setBoardType("faq");
			vo.setBoardType2("Faq");
			vo.setBlbdDvCd("002");
			vo.setListUrl("/mobile/brd/faq/engFaq.do");
			vo.setViewUrl("/mobile/brd/faq/engFaqView.do");
		} else if (urlPath.indexOf("/mobile/brd/qna/engQnaView.do") > -1) {	// 문의내역
			vo.setBoardType("qna");
			vo.setBoardType2("Qna");
			vo.setBlbdDvCd("003");
			vo.setListUrl("/mobile/brd/qna/engQna.do");
			vo.setViewUrl("/mobile/brd/qna/engQnaView.do");
		} else if (urlPath.indexOf("/mobile/brd/data/engDataView.do") > -1) {		// 취업노하우
			vo.setBoardType("data");
			vo.setBoardType2("Data");
			vo.setBlbdDvCd("004");
			vo.setListUrl("/mobile/brd/data/engData.do");
		...
		return "/mobile/brd/" + vo.getBoardType() + "/brdAEng" + vo.getBoardType2() + "View";
	}
	 ...
	 */
	@SessionChecker
	@RequestMapping(value = {"/mobile/brd/qna/qnaHandle.do"})
	public String handleUBDQanda(ModelMap model, @ModelAttribute("searchVO") UserBoardVO vo, HttpServletRequest request) throws Exception {
		...
		if (urlPath.indexOf("/mobile/brd/qna/qnaHandle.do") > -1) {	//문의하기
			vo.setBoardType("qna");
			vo.setBoardType2("Qna");
			vo.setBlbdDvCd("003");
		...
		return "/mobile/brd/" + vo.getBoardType() + "/brdA" + vo.getBoardType2() + "Handle";
	}
	 ...
	 */
	@SessionChecker
	@RequestMapping(value = "/mobile/brd/qna/qnaSave.do")	
	public ModelAndView registerQanda(@ModelAttribute("searchVO") UserBoardVO searchVO, UserBoardVO vo, BindingResult bindingResult, 
		...
		if ( bdotSeq != null && !"".equals(bdotSeq) ) {
			...
			resultPage = "/mobile/brd/qna/qnaHandle.do";
		} else {
		
			if (result > 0) {
				resultMsg = egovMessageSource.getMessage("success.common.insert");
				resultPage = "/mobile/brd/qna/qna.do";
	...
	/**
	  ...
	  */
	@SessionChecker
	@RequestMapping(value = "/mobile/brd/qna/qnaDelete.json", headers="Accept=application/json" )
