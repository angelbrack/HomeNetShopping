package korea.wrk.idx.home.service.impl;
...
public class UserMHomeServiceImpl implements UserMHomeService {
	...
	public List<EgovMap> retrieveBannerList(UserMHomeVO vo) throws Exception {
		return mybatisDataAccessDAO.list("korea.wrk.idx.home.service.UserMHomeService.selectUserMHomeService_S01", vo);
	}

	//취업교육
	@SuppressWarnings("unchecked")
	public List<EgovMap> retrieveProList(UserMHomeVO vo) throws Exception {
		return mybatisDataAccessDAO.list("korea.wrk.idx.home.service.UserMHomeService.selectUserMHomeService_S02", vo);
	}

	
	@SuppressWarnings("unchecked")
	public List<EgovMap> retrieveMainProList(UserMHomeVO vo) throws Exception {
		return mybatisDataAccessDAO.list("korea.wrk.idx.home.service.UserMHomeService.selectUserMHomeService_S04", vo);
	}
	...
	public List<EgovMap> retrieveDayList(UserMHomeVO vo) throws Exception {
		return mybatisDataAccessDAO.list("korea.wrk.idx.home.service.UserMHomeService.selectUserMHomeService_S03", vo);
	}	
