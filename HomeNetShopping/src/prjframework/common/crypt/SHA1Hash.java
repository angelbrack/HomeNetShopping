 ...
 * �ܹ��� ��ȣȭó��
 * ORACLE PLSQL ���� ������ ���� ��� �ʿ�.
 * ���: loadjava -u lrtiusr/lrtiusr@LRTIDEV -v -resolve SHA1Hash.java
 * ����: dropjava -u lrtiusr/lrtiusr@LRTIDEV -v SHA1Hash
 * @author hwanggu
 *
 */
public class SHA1Hash {
	...
	public static byte[] getBytes(byte[] data, int length, byte defaultValue) {
...
//		if (args.length < 1) {
//			//System.out.println("Usage: java SHA1Hash <text>");
//			return;
//		}
		//��� ���õ����� Ȯ��
		String charset = "euc-kr";
		String s = SHA1Hash.hashToBase64("southkorea", charset);
		if(s.equals("SAe8CPiB7KeE9Qh0NQEU7Z+iToY=")){
