...
public class MemberVO extends PagerVO implements Serializable {
	
	@Size(min=8, max=13, message="{errors.required} {errors.minmaxlength}") private String loginId;
	...
	private String frnNm;
	private String pwdFailTms;
	private String optrAuthCd;
	private String userAuthExpyDt;
	private String optrApprStatCd;
	private String eduOptrApprStatCd;
	private String optrApprStatNm;
	private String eduOptrApprStatNm;
	...
	public String getFrnNm() {
		return frnNm;
	}
	public void setFrnNm(String frnNm) {
		this.frnNm = frnNm;
	}
	...
	public String getEduOptrApprStatCd() {
		return eduOptrApprStatCd;
	}
	public void setEduOptrApprStatCd(String eduOptrApprStatCd) {
		this.eduOptrApprStatCd = eduOptrApprStatCd;
	}
	public String getOptrApprStatNm() {
		return optrApprStatNm;
	}
	public void setOptrApprStatNm(String optrApprStatNm) {
		this.optrApprStatNm = optrApprStatNm;
	}
	public String getEduOptrApprStatNm() {
		return eduOptrApprStatNm;
	}
	public void setEduOptrApprStatNm(String eduOptrApprStatNm) {
		this.eduOptrApprStatNm = eduOptrApprStatNm;
	}
