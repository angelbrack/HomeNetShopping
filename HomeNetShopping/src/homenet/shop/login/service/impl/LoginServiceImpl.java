package homenet.shop.login.service.impl;
...
public class LoginServiceImpl implements LoginService {
	...
	public List<RoleVO> selectUserRole(String userNo) throws Exception {
		return mybatisDataAccessDAO.list("homenet.shop.login.service.LoginService.selectLogin_S03", userNo);
	}
	
	public void updateAdminLoginInfo(UserLoginVO vo) throws Exception {
		mybatisDataAccessDAO.insert("homenet.shop.login.service.LoginService.insertLogin_I01", vo) ;
	}
	
	public EgovMap selectScafLoginKInfo(UserLoginVO vo) throws Exception {
		return (EgovMap) mybatisDataAccessDAO.select("homenet.shop.login.service.LoginService.selectLogin_S04", vo);
	}
	
	public int selectJobKUserCheck(UserLoginVO vo) throws Exception {
		return (Integer) mybatisDataAccessDAO.select("homenet.shop.login.service.LoginService.selectLogin_S05", vo);
	}
	
	public String selectUserNoNext() throws Exception {
		return (String) mybatisDataAccessDAO.select("homenet.shop.login.service.LoginService.selectLogin_S06", null);
	}
	
	public void insertNwrk100tl(UserLoginVO vo) throws Exception {
		mybatisDataAccessDAO.insert("homenet.shop.login.service.LoginService.insertLogin_I02", vo) ;
	}
	
	public void insertNwrk101tl(UserLoginVO vo) throws Exception {
		mybatisDataAccessDAO.insert("homenet.shop.login.service.LoginService.insertLogin_I03", vo) ;
	}
	
	public void updateNwrk100tl(UserLoginVO vo) throws Exception {
		mybatisDataAccessDAO.update("homenet.shop.login.service.LoginService.updateLogin_U01", vo) ;
	}
	
	public UserLoginVO selectLoginInfo(UserLoginVO vo) throws Exception {
		return (UserLoginVO) mybatisDataAccessDAO.select("homenet.shop.login.service.LoginService.selectLogin_S07", vo);
	}
	
	public void updatePwdFail(UserLoginVO vo) throws Exception {
		mybatisDataAccessDAO.update("homenet.shop.login.service.LoginService.updateLogin_U02", vo) ;
	}
	
	public void updatePwdTms(String userNo) throws Exception {
		mybatisDataAccessDAO.update("homenet.shop.login.service.LoginService.updateLogin_U03", userNo) ;
	}
	
	public void updateLoginInfo(UserLoginVO vo) throws Exception {
		mybatisDataAccessDAO.insert("homenet.shop.login.service.LoginService.insertLogin_I04", vo) ;
	}
	
	public EgovMap selectSsoLoginInfo(UserLoginVO vo) throws Exception {
		return (EgovMap) mybatisDataAccessDAO.select("homenet.shop.login.service.LoginService.selectLogin_S08", vo);
	}
