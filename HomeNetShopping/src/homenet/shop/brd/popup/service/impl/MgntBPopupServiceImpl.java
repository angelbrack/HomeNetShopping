package homenet.shop.brd.popup.service.impl;
...
public class MgntBPopupServiceImpl implements MgntBPopupService {
	...
	public List<EgovMap> retrieveList(MgntBPopupVO vo) throws Exception {
		return mybatisDataAccessDAO.list("homenet.shop.brd.common.service.MgntBPopupService.selectPopup_S01", vo);
	}

	public int retrieveCount(MgntBPopupVO vo) throws Exception {
		return (Integer) mybatisDataAccessDAO.select("homenet.shop.brd.common.service.MgntBPopupService.selectPopup_S02", vo);
	}

	public MgntBPopupVO retrieveInfo(MgntBPopupVO vo) throws Exception {
		return (MgntBPopupVO) mybatisDataAccessDAO.select("homenet.shop.brd.common.service.MgntBPopupService.selectPopup_S03", vo);
	}

	@SuppressWarnings("unchecked")
	public List<EgovMap> retrieveFile(MgntBPopupVO vo) throws Exception {
		return mybatisDataAccessDAO.list("homenet.shop.brd.common.service.MgntBPopupService.selectPopup_S04", vo);
	}
	...
	public int register(MgntBPopupVO vo) throws Exception {
		...
		result += (Integer) mybatisDataAccessDAO.insert("homenet.shop.brd.common.service.MgntBPopupService.insertPopup_I01", vo);
	...
	public int modify(MgntBPopupVO vo) throws Exception {
		...
		result += (Integer) mybatisDataAccessDAO.insert("homenet.shop.brd.common.service.MgntBPopupService.updatePopup_U01", vo);

		return result;
	}

	public int delete(MgntBPopupVO vo) throws Exception {
		return mybatisDataAccessDAO.delete("homenet.shop.brd.common.service.MgntBPopupService.deletePopup_D01", vo);
	}
