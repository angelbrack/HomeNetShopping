package homenet.shop.brd.banner.service.impl;
...
public class MgntBBannerServiceImpl implements MgntBBannerService {
	...
	public List<EgovMap> retrieveList(MgntBBannerVO vo) throws Exception {
		return mybatisDataAccessDAO.list("homenet.shop.brd.common.service.MgntBBannerService.selectBanner_S01", vo);
	}

	public int retrieveCount(MgntBBannerVO vo) throws Exception {
		return (Integer) mybatisDataAccessDAO.select("homenet.shop.brd.common.service.MgntBBannerService.selectBanner_S02", vo);
	}

	public MgntBBannerVO retrieveInfo(MgntBBannerVO vo) throws Exception {
		return (MgntBBannerVO) mybatisDataAccessDAO.select("homenet.shop.brd.common.service.MgntBBannerService.selectBanner_S03", vo);
	}

	@SuppressWarnings("unchecked")
	public List<EgovMap> retrieveFile(MgntBBannerVO vo) throws Exception {
		return mybatisDataAccessDAO.list("homenet.shop.brd.common.service.MgntBBannerService.selectBanner_S04", vo);
	}
	...
	public int register(MgntBBannerVO vo) throws Exception {
		...
		result += (Integer) mybatisDataAccessDAO.insert("homenet.shop.brd.common.service.MgntBBannerService.insertBanner_I01", vo);
	...
	public int modify(MgntBBannerVO vo) throws Exception {
		...
		result += (Integer) mybatisDataAccessDAO.insert("homenet.shop.brd.common.service.MgntBBannerService.updateBanner_U01", vo);

		return result;
	}

	public int delete(MgntBBannerVO vo) throws Exception {
		return mybatisDataAccessDAO.delete("homenet.shop.brd.common.service.MgntBBannerService.deleteBanner_D01", vo);
	}
