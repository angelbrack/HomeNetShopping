...
var recuRecruitList = {
	...
	fnTab : function(searchEtrFomCd) {
		...
		frmInit.action = CTX_PATH + "/mobile/recu/recruit/engRecruitList.do";
		frmInit.submit();
	...
	fnListPage : function(pageNo) {
		...
		frm.method = "post";
		frm.target = "_self";
		frm.action = CTX_PATH + "/mobile/recu/recruit/engRecruitList.do";
	...
	fnView : function(recuInfoNo) {
		...
		frm.method	= "post";
		frm.target	= "_self";
		frm.action	= CTX_PATH + "/mobile/recu/recruit/engRecruitView.do";
		frm.submit();
	},
	// 폼 초기화 리스트 페이지 이동
	fnInitList  : function() {
